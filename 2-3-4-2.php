...
<body>
	<form method="post" enctype="multipart/form-data">
		...
		<label for="name3">Candidate 3 Name:</label>
		<input type="text" name="name3" required><br><br>
		<label for="admission_number3">Candidate 3 Admission Number:</label>
		<input type="text" name="admission_number3" required><br><br>
		<label for="class3">Candidate 3 Class:</label>
		<input type="text" name="class3" required><br><br>
		<label for="photo3">Candidate 3 Photo:</label>
		<input type="file" name="photo3" required><br><br>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $name3 = $_POST['name3'];
    $admission_number3 = $_POST['admission_number3'];
    $class3 = $_POST['class3'];
    $photo3 = $_FILES['photo3']['name'];

    // Save data to text file
    $file = fopen("sportsassicaptaincandetails.txt", "a");
    ...
    fwrite($file, "Candidate 3\n");
    fwrite($file, "Name: " . $name3 . "\n");
    fwrite($file, "Admission Number: " . $admission_number3 . "\n");
    fwrite($file, "Class: " . $class3 . "\n");
    fwrite($file, "Photo: " . $photo3 . "\n\n");

    fclose($file);

    // Save photos to server
    $target_dir = "sportsassicaptainphoto/";
